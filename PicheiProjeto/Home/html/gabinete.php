...
<head>
	...
	<title>Pichei Gabinete</title>
	<link rel="stylesheet" type="text/css" href="../css/gabinete.css">
...
<body>
	...
	<div id="columns" class="columns_2">
		...
		$sql = "select * from produto where categoria like 'gabinete' order by titulo";
...
<script lang="javascript">
	...
	function media() {
		if (n1.value == "" || isNaN(n1.value)) { //isNaN is not a number
			alert("Informe um valor para n1 !");
			n1.value = "";
			n1.focus();
			return false;
		}
		if (n2.value == "" || isNaN(n2.value)) { //isNaN is not a number
