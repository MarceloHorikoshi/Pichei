...
<head>
	...
	<title>Pichei Processador</title>
	<link rel="stylesheet" type="text/css" href="../css/processador.css">
...
<body>
	...
	<div align="center">
		<p>
			...
			<font face="Roboto" color="black" size="25">
				<h1>Processadores (AMD e Intel)</b></h1>
			</font>
		</p>
	</div>
	...
	<div id="columns" class="columns_5">
		...
		$sql = "select * from produto where categoria like 'processador' order by titulo";
