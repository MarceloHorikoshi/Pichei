...
<head>
	...
	<title>Pichei Placa de Vídeo</title>
	<link rel="stylesheet" type="text/css" href="../css/placavideo.css">
...
<body>
	...
	<div id="columns" class="columns_5">
		...
		$sql = "select * from produto where categoria like 'video' order by titulo";
